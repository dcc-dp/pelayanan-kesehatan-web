...
const DataDrugs = () => {
  ...
  const [filterDrugs, setFilterDrugs] = useState("all");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error("Gagal menghapus drugs");
      }
...
const filteredData = useMemo(() => {
  return drugsData.filter((item) => {
    ...
    const filterMatch =
      filterDrugs === "all"
        ? true
        : item.specialis_name === filterDrugs;

    return searchMatch && filterMatch;
  });
}, [drugsData, searchQuery, filterDrugs]);
                  ...
                  {filteredData.length > 0 ? (
                    ...
                    <tr>
                      ...
                      <h3 className="font-semibold text-gray-700">
                        Tidak ada data drugs.
                      </h3>

                      <p className="text-gray-400 mt-2">
                        Klik tombol "Add drugs" untuk menambahkan drugs baru.
                      </p>
