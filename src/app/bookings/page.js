...
const DataBookings = () => {
  ...
  // Perbaikan: Tambahkan state untuk Modal Edit yang dipanggil di bagian bawah kode
  const [openEdit, setOpenEdit] = useState(false);
  const [editId, setEditId] = useState(null);

  // Perbaikan: Jadikan loadData sebagai fungsi utama agar bisa dipakai di useEffect dan EditModal
  const loadData = async () => {
    setLoading(true);
    try {
      const response = await fetch("/api/bookings");
      const data = await response.json();
      // Perbaikan: Typo (sebelumnya setBookingData)
  ...
  // Perbaikan: Penulisan useEffect yang benar
  useEffect(() => {
    loadData();
  }, []);
    ...
    <div className="flex min-h-screen bg-[#f4f7fe]">
      ...
      <main className="flex-1">
        ...
        <div className="bg-white px-8 py-5 border-b flex justify-between items-center">
          <div>
            <h1 className="text-4xl font-bold text-[#1b2559]">Bookings</h1>
            <p className="text-gray-500 mt-1">Dashboard &gt; Bookings</p>
          </div>
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h3 className="font-semibold text-[#1b2559]">Admin</h3>
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-3xl p-6 border shadow-sm">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  {/* Perbaikan: Typo (sebelumnya bookingData.length) */}
            ...
            <div className="bg-white rounded-3xl p-6 border shadow-sm">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-gray-500 text-sm">Booking Cancelled</p>
                  <h2 className="text-4xl font-bold text-[#1b2559] mt-3">62</h2>
                  <p className="text-red-400 text-sm mt-2">
                    ↓ 2.7% dari bulan lalu
                  </p>
                </div>
                  ...
                  {loading ? (
                    ...
                    filteredData.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-5">{item.recipes_id}</td>
                        <td className="px-6 py-5">Rp {item.total}</td>
...
// Perbaikan: Sebelumnya export default DataBooking (kurang 's')
