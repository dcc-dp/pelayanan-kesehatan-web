...
const filteredData = useMemo(() => {
  return categorySpesialisData.filter((item) => {
    ...
    const filterMatch =
      filterCategory === "all"
        ? true
        : item.specialis_name === filterCategory;

    return searchMatch && filterMatch;
  });
}, [categorySpesialisData, searchQuery, filterCategory]);
  ...
  <div className="flex items-center gap-5">
    ...
    <div>
      <p className="text-gray-500 text-sm">
        Total Category Specialist
      </p>

      <h2 className="text-4xl font-semibold text-gray-900">
        {categorySpesialisData.length}
      </h2>
    </div>
                  ...
                  {filteredData.length > 0 ? (
                    ...
                    <tr>
                      ...
                      <p className="text-gray-400 mt-2">
                        Klik tombol "Add Category" untuk menambahkan kategori baru.
                      </p>
